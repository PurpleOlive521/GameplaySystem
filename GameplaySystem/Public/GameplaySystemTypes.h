...
struct GAMEPLAYSYSTEM_API FGameplaySystemAnimMontageInfo
{
	...
	// This is a bit hacky, but is used to route notifies from blendspaces to the correct ability. We have no way of knowing what AnimMontage the blendspace is playing
